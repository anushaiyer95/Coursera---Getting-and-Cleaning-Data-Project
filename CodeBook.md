...
Feature Selection
================
The  README.MD file and the features.txt files in the original dataset will help you learn more about the feature selection for this dataset. And there you will find the this description:
